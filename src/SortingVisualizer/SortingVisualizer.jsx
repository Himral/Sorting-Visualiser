...
const PRIMARY_COLOR = '#512B81';

// This is the color of array bars that are being compared throughout the animations.
const SECONDARY_COLOR = '#7B2869';
    ...
    return (
      <div className="array-container">
        <div className = 'navbar'>
          <div className = 'Heading'><h1>Sorting Visualiser</h1></div>
        ...
        <button className = "main-button" onClick={()=> this.selectionSort()}>Selection Sort</button>
          </div>
        ...
        {array.map((value, idx) => (
         ...
         <div className='footer'>
            ...
            <p>Made with ❤️ by <a href = "https://www.linkedin.com/in/himral-garg-a2b30621a/">Himral Garg</a></p>
